...
public class JefesScundarios extends Jefes{
	...
	public JefesScundarios(String nombre, String tipo, int vida, int ataque) {
	...
	public String toString() {
		return "Este jefes es principales y su nombre es " + nombre + ", el tipo es" + tipo + 
