...
public class CombatirJefeCreado {
	/**
	 ...
	 */
	public static void combateContraJefePersonalizado(Jefes jefePersonalizado,Personaje personajePrincipal,Scanner saltoLinea) {
