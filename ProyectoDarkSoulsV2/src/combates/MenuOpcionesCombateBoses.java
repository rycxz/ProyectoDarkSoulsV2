...
import jefes.CreacionJefePersonalizado;
import jefes.Jefes;
...
public class MenuOpcionesCombateBoses {
	 ...
	 * @param numeros 
	 */
	public static void menuEleccioCombates(ArrayList<JefesPrincipales> todosJefesPrincipales,
			ArrayList<JefesSecundarios> jefesSecundarios, Personaje personajePrincipal, Scanner numeros, Scanner letras) {
		ArrayList<Jefes> todosJefes = new ArrayList<>();
		todosJefes.addAll(todosJefesPrincipales);
		todosJefes.addAll(jefesSecundarios);
		...
		do {
			...
			case 1:
				...
				do {
					...
					case 1:
						CombateContraTodosLosJefes.aciertoBoss(todosJefes, personajePrincipal, letras);
						break;
					case 2:
						CombateContraTodosLosJefes.PeleaBosesDificil(todosJefes, personajePrincipal, letras);
						break;
					case 3:
						CombateContraTodosLosJefes.PeleaBosesFacil(todosJefes, personajePrincipal, letras);
						break;
					case 4:
			...
			case 5:
				...
				System.out.println(
						"@#############################################################MMMMMMMMMMMMMMMMMMBBBBMMMMBB&AMBAHM###MMMMMMM#\r\n"
